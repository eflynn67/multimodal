...
############################################
    ...
    iso_ind_fine = utilities.SurfaceUtils.find_local_minimum(EE_fine,searchPerc=[0.30,0.30],returnOnlySmallest=False)
...
###############################################################################
    ...
    for p,RN in enumerate(RNArr):
        ...
        FireParams = {"dtMax":.1,"dtMin":10**(-6),"nAccel":10,"fInc":1.1,"fAlpha":0.99,\
             "fDecel":0.5,"aStart":0.1,"maxmove":np.array([.5,.5])} 
