...
if __name__ == "__main__":
    ...
    gs_ind = utilities.SurfaceUtils.find_local_minimum(EE,searchPerc=[0.10,0.10],returnOnlySmallest=True)
    ...
    for i,fpath in enumerate(path_files_asym):
        ...
        path_call = utilities.InterpolatedPath(data[:iso_indx])
