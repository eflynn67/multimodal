...
############################################
    ...
    gs_ind = utilities.SurfaceUtils.find_local_minimum(EE_fine,searchPerc=[0.10,0.10],returnOnlySmallest=True)
    ...
    E_iso_fine  = E_iso_fine_arr[iso_sorted[1]]
    iso_coord_fine = iso_coord_fine_arr[iso_sorted[1]]
