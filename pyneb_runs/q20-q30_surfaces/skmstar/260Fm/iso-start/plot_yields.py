...
mode = 'symm'
center_method = 'lines'
mass_dataFiles = sorted(glob.glob(f'shift-*/nlfs_yields/frag_result/mass_{mode}_Eshift_*_{center_method}.dat'))
charge_dataFiles = sorted(glob.glob(f'shift-*/nlfs_yields/frag_result/charge_{mode}_Eshift_*_{center_method}.dat'))
