...
if __name__ == "__main__":
    ...
    E_const_arr = [0,0.5,1]
    path_files_asym = sorted(glob.glob('shift-*/256Fm_path_Asymmetric_2_Mass_True_Econst_0.0*.txt'))
    path_files_sym = sorted(glob.glob('shift-*/256Fm_path_Symmetric_1_Mass_True_Econst_0.0*.txt'))
