...
if __name__ == "__main__":
    ...
    E_const_arr = [0,0.5,1]
    path_files_asym = sorted(glob.glob(f'shift-*/{nuc}_path_Asymmetric_co_Mass_True_Econst_*.txt'))
    ...
    print(gs_ind)
    iso_ind = utilities.SurfaceUtils.find_local_minimum(EE,searchPerc=[0.70,0.40],returnOnlySmallest=False)
    ...
    E_iso_grid  = E_iso_grid_arr[iso_sorted[2]]
    iso_coord_grid = iso_coord_grid_arr[iso_sorted[2]]
    print(iso_coord_grid_arr)
    print(iso_sorted)
    #print(E_iso_grid)
