...
###############################################################################
    ...
    path_type = ['Asymmetric_2']#,'Asymmetric_2','Compact','Elongated']
    NImgs = 122
    k = 2.0 
    kappa = 1.0
    ...
    ### define initial path
    R0 = iso_coord_grid
    # [240.0,0.0,50.0] compact. works
    # [280.0,0.0,100.0] elongated. works
    # [200,16,54] asymmetric 1 works 
    # [228,7,47] asymmetric 2 (works?)
    
    #RNArr = [[200,16,54],[228,7,47],[240,0,50],[280,0,100]]
    RNArr = [[226.5,6,47]]
