...
##################################################################################### 
    ...
    OTS_df = OTS_df.drop(OTS_df[OTS_df['Q40']>120].index)
    OTS_df = OTS_df.drop(OTS_df[OTS_df['Q40']<40].index)
    OTS_df = OTS_df.drop(OTS_df[OTS_df['Q20']<100].index)
    OTS_df.to_csv('258Fm_OTS_interp_cubic.txt',sep=',',index=False,float_format='%.2f')